...
function (_React$PureComponent) {
  ...
  function JobsPanel(props) {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_9__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_7__["default"])(_this), "saveDataToLocalStorage", function (data) {
      if (window) {
        ...
        if (oldStorage && oldStorage[_column]) {
          var obj = oldStorage;
          obj[_column] = [].concat(Object(_babel_runtime_corejs2_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_2__["default"])(oldStorage[_column]), [data]);
          ...
          var _obj = _babel_runtime_corejs2_core_js_object_assign__WEBPACK_IMPORTED_MODULE_0___default()(oldStorage, Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_9__["default"])({}, _column, [data]));
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_9__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_7__["default"])(_this), "openModal", function (item, index) {
      if (window) {
        var oldStorage = JSON.parse(localStorage.getItem('data'));
        ...
        if (oldStorage && oldStorage[column]) {
          ...
          var _obj3 = _babel_runtime_corejs2_core_js_object_assign__WEBPACK_IMPORTED_MODULE_0___default()(oldStorage, Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_9__["default"])({}, column, [data]));

          localStorage.setItem('data', _babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_1___default()(_obj3));

          _this.loadLocalStorage();
        } else {
          var _obj4 = {};
          _obj4[column] = [data];
          localStorage.setItem('data', _babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_1___default()(_obj4));
...
//# sourceMappingURL=index.js.107ecee314d8350aa73a.hot-update.js.map