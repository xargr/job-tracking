...
/* harmony import */ var _lib_dragAndDrop__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../lib/dragAndDrop */ "./lib/dragAndDrop.js");
...
var JobContextProvider = function JobContextProvider(_ref) {
  ...
  var onDragEnd = function onDragEnd(result) {
    return Object(_lib_dragAndDrop__WEBPACK_IMPORTED_MODULE_6__["default"])(result, state, setState);
  };
  ...
  var modalTrigger = function modalTrigger(data) {
    setState(Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_0__["default"])({}, state, {
      ...
      modalData: Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_0__["default"])({}, state.modalData, data)
    }));
  };
  ...
  var modalSubmit = function modalSubmit(modalVal) {
    var _objValues = objValues,
        company = _objValues.company,
        position = _objValues.position;
    var uniqId = uuid_v4__WEBPACK_IMPORTED_MODULE_4___default()();
  };
...
//# sourceMappingURL=index.js.15653724ab1f56306fb5.hot-update.js.map