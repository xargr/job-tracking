...
})(["grid-row:header;padding:2em;@media (max-width:767pxpx){font-size:2em;}"]);
...
})(["font-size:2.3em;font-weight:700;margin-bottom:0.25em;font-family:'Red Hat Text',sans-serif;@media (min-width:768px) and (max-width:1024px){font-size:2em;}@media (max-width:767pxpx){font-size:2em;}"]);
...
//# sourceMappingURL=_app.js.c5eba78fdee0b5211e0a.hot-update.js.map