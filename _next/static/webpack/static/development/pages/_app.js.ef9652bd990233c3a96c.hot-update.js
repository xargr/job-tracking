...
})(["font-style:italic;@media (min-width:768px) and (max-width:1024px){font-size:0.85em;}@media (max-width:767px){display:none;}"]);
...
})(["width:50%;float:left;@media (max-width:767px){width:100%;display:block;text-align:center;}"]);
...
})(["width:50%;float:right;text-align:right;margin-top:30px;@media (max-width:767px){width:100%;display:block;text-align:center;}"]);

/***/ })

})
//# sourceMappingURL=_app.js.ef9652bd990233c3a96c.hot-update.js.map